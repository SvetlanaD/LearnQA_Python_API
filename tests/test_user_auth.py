...
class TestUserAuth(BaseCase):
    ...
    @allure.description("This test case successfully authorize user by email and password")
    ...
    def test_auth_user(self):
        ...
        Assertions.assert_json_value_by_name(response2,
                                             ...
                                             "User id from auth method isn't equal to user id from check method ")

    @allure.suite("Negative")
    @allure.description("This test case checks authorization w/o sending auth cookie or token")
